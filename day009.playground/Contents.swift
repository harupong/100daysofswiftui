...
func doImportantWork(first: (print("first")) -> Void, second: (print("second")) -> Void, third: (print("third")) -> Void) {
...
let luckyOddnumbers = luckyNumbers.filter { !$0.isMultiple(of: 2) }
print(luckyOddnumbers)

let luckyOddSortedNumbers = luckyOddnumbers.sorted()

luckyOddSortedNumbers.map { print("\($0) is a lucky number") }

//func solveCheckpoint5() {
//    filterEvens()
//    sortAscending()
//    mapToPrint()
//}
